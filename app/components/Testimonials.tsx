        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 transition-all duration-500 ease-in-out">
          {visibleTestimonials.map((testimonial, index) => (
            <div
              ...
              className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300 flex flex-col h-full min-h-450px]" // Added minimum height
            >
              {/* Card Header */}
              ...
              <div className="p-8 flex flex-col flex-1">
                ...
                <p className="text-gray-700 text-base leading-relaxed text-center flex-1">
                  {/* Increased text size from text-sm to text-base */}
                  {testimonial.text}
                </p>
              </div>
