  ...
  return (
    ...
    <div className="max-w-4xl mx-auto p-6  ">
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl md:text-4xl font-bold text-neon-red mb-2">Fast Turnaround & Warranty Backed Services</h1>
        <p className="text-gray-300 text-lg mb-2">Get back on the road with peace of mind!</p>
        {/* <p className="text-gray-500">Audi 2021 Audi A1 Petrol Cylinder Head</p> */}
      </div>
      ...
      <div className=" gap-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <input
                ...
                className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <p className="text-sm text-gray-500 mt-1">We use this to locate trusted garages close to you</p>
            </div>
          </div>
        ...
        {/* Optional Details */}
        <div className="border border-gray-300 rounded-lg p-6 bg-gray-50 mt-20">
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2">
              <label className="flex items-center">
                <input type="radio" name="drives" value="yes" onChange={handleInputChange} className="mr-3 h-4 w-4" />
                <span className="text-gray-700">Yes</span>
              </label>
              <label className="flex items-center">
                <input type="radio" name="drives" value="no" onChange={handleInputChange} className="mr-3 h-4 w-4" />
          ...
          <div>
            ...
            />
            <p className="text-sm text-gray-500 mt-2">Add any extra notes about your vehicle here.</p>
          </div>
        </div>
      </div>
    </div>
