import { FaTruckPickup, FaCertificate, FaUserShield, FaIndustry } from 'react-icons/fa';
  ...
  return (
    <section className="py-20 bg-[#F3F9FF]">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center text-gray-800 mb-14">Why Trust Us?</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          {badges.map((badge, index) => (
            <div
              key={index}
              className="relative bg-white pt-14 pb-6 px-5 text-center rounded-xl shadow-md hover:shadow-lg transition"
            >
              {/* Icon circle */}
              ...
              <h3 className="text-lg font-semibold text-gray-800 mt-8">{badge.title}</h3>
