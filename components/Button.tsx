...
const Button: React.FC<ButtonProps> = ({
  ...
  const getVariantStyles = () => {
    if (variant === "green") {
      return "relative rounded-xl font-semibold border-2 border-[#057532] bg-gradient-to-r from-[#057532] to-[#49B34B] text-white px-8 py-3 hover:border-[#057532] hover:text-[#057532] transition-all duration-400 overflow-hidden before:absolute before:inset-0 before:bg-white before:opacity-0 hover:before:opacity-100 before:transition-opacity before:duration-400";
    }
