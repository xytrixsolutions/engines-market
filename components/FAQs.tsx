...
const faqs: FAQ[] = [
    ...
    {
      question: 'What are reconditioned engines, and how do they compare to new and used engines?',
      answer:
    ...
    },
    {
      ...
      answer: 'Engine Market itself does not offer warranties, but our verified suppliers do.',
      answerList: [
    ...
    },
    {
      ...
      answer: 'Engine replacement costs vary based on the vehicle make, model, and engine type:',
      answerList: [
    ...
    {
      question: 'What’s the difference between used, reconditioned, and new engines?',
      answerList: [
    ...
    {
      question: 'Do you offer pick-up and drop-off services for engine replacement?',
      answer:
    ...
    {
      question: 'Do you supply performance engines for tuning or modifications?',
      answer:
...
const FAQSection = () => {
  ...
  return (
    <section className="bg-[#f8fbfd] py-20 px-4">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <div key={index} className="bg-white rounded-xl shadow-sm overflow-hidden transition-all duration-300">
              ...
              <div
                className={`transition-all duration-300 ease-in-out px-5 text-sm text-gray-700 ${
                  openIndex === index ? 'max-h-[1000px] opacity-100 pb-4 pt-1' : 'max-h-0 opacity-0'
                } overflow-hidden`}
              >
